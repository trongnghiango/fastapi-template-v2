...
# WARNING: Ensure imports from `fastapi_template_v2` comes after this line
from fastapi_template_v2 import app, settings, db  # noqa
from fastapi_template_v2.cli import create_user, cli  # noqa
